<%@ Page Title="Create Services" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="create_services.aspx.vb" Inherits="create_services" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding: 0px; margin: 0px; width: 100%; background-color: #003399;">
        <asp:Label ID="Label1" runat="server" SkinID="header_lbl" 
            Text="Create Services"></asp:Label>
    </div>
    <br />
    <table border="0" cellpadding="2" cellspacing="0">
        <tr>
            <td align="left" valign="top">
                <asp:Label ID="Label5" runat="server" Text="Service Category :"></asp:Label>
            </td>
            <td align="left" valign="top">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <asp:Label ID="Label8" runat="server" Text="Service Charge :"></asp:Label>
            </td>
            <td align="left" valign="top">
        ...
        <tr>
            ...
            <td align="left" valign="top" colspan="2">
                <asp:CheckBox ID="CheckBox1" runat="server" 
                    Text="Add At Spares During Billing" Visible="False" />
            </td>
        </tr>
        <tr>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        ErrorMessage="Please Enter Service Category..." SetFocusOnError="True" 
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ...
        ErrorMessage="Please Enter Car Type..." SetFocusOnError="True" 
        ValidationGroup="s"></asp:RequiredFieldValidator>
