<%@ Page Title="Service Management" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Customer_wise_sales_report.aspx.vb" Inherits="Customer_wise_sales_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div style="padding: 0px; margin: 0px; width: 100%; background-color: #003399;">
            <asp:Label ID="Label1" runat="server" SkinID="header_lbl" 
                Text="Customer Wise Report"></asp:Label>
        </div>
        <br />
        <br />
