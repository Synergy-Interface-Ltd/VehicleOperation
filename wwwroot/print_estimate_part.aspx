<%@ Page Title="Estimate" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="print_estimate_part.aspx.vb" Inherits="print_estimate_part" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" 
            ...
            <ContentTemplate>
                ...
                <table cellpadding="2" cellspacing="0" border="0" 
                    style="width: 831px;">
                   <tr><td align="left" valign="top" width="831px;">
                   ...
                   <asp:Label ID="Label61" runat="server" EnableTheming="False" 
                    Font-Bold="True" Font-Names="Calibri" Font-Size="Medium" Text="ESTIMATE"></asp:Label></div>
                    ...
                    style="border: 1.25px solid #000000; width: 100%;"> <tr>
                        <td align="left" colspan="1" valign="top">
                            <asp:Label ID="Label47" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Medium" Text="Date :"></asp:Label>
&nbsp;<asp:Label ID="TextBox27" runat="server" EnableTheming="False" Font-Names="Calibri" 
                                Font-Size="Medium"></asp:Label>
                        </td>
                        <td align="center" colspan="2" valign="top">
                            <asp:Label ID="Label46" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Medium" Text="Estimate No :"></asp:Label>
                     ...
                     <tr   >
                        <td align="right" valign="top" width="70%" id="l35" runat="server">
                            <asp:Label ID="Label11" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Medium" Text="Cash Discount :"></asp:Label>
                        </td>
                    ...
                    <tr >
                        <td align="right" valign="top" id="l48" runat="server">
                            <asp:Label ID="Label48" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Medium" Text="Advance :"></asp:Label>
                        </td>
                        ...
                        <tr>
                            <td align="left" colspan="3" valign="top">
                                        ...
                                        <asp:Label ID="TextBox44" runat="server" EnableTheming="False" Font-Bold="True" 
                                            Font-Names="Calibri" Font-Size="Medium" Font-Underline="True">Terms &amp; Conditions :</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="3" style="font-family: Calibri; font-size: medium" 
                                valign="top">
                                ...
                                <tr>
                                    <td align="center" colspan="2" valign="top" width="35%">
                                        ...
                                        <asp:Label ID="TextBox33" runat="server" EnableTheming="False" Font-Bold="True" 
                                            Font-Names="Calibri" Font-Size="Medium">Customer</asp:Label>
                                    </td>
                                    ...
                                    <td align="center" valign="top" width="35%">
                                        ...
                                        <asp:Label ID="lTextBox35" runat="server" EnableTheming="False" 
                                            Font-Bold="True" Font-Names="Calibri" Font-Size="Medium">Engineer</asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
