...
Partial Class add_order_status
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Button6.Visible = True Then
            ...
            strnewrecord = "select Id,Name,Status from OrderStatus order by id"
    ...
    Protected Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        Myconnection.Open()
        Dim maxId = genf.returnvaluefromdv("Select max(id) from OrderStatus", 0)
        ...
        Else
            status = 0
        End If
        strnewrecord = "INSERT INTO OrderStatus (Id,Name,Status) values (" + statusId + ",'" + TextBox1.Text + "'," & status & ")"
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Else
            status = 0
        End If
        strnewrecord = "update OrderStatus set Name='" & TextBox1.Text & "',Status=" & status & " where Id=" & statusId & ""
        Mycommand = New SqlCommand(strnewrecord, Myconnection)
        Mycommand.ExecuteNonQuery()
        Myconnection.Close()
        Button6.Visible = True
    ...
    Protected Sub Button4_Click(sender As Object, e As System.EventArgs) Handles Button4.Click
        ...
        Dim statusId = Gridview1.SelectedRow.Cells(1).Text
        strnewrecord = "delete from orderstatus where Id=" & statusId & ""
        Mycommand = New SqlCommand(strnewrecord, Myconnection)
        Mycommand.ExecuteNonQuery()
        Myconnection.Close()
        Button6.Visible = True
