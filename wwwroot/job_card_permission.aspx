<%@ Page Title="Job Sheet Permission" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="job_card_permission.aspx.vb" Inherits="job_card_permission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div style="padding: 0px; margin: 0px; width: 100%; background-color: #003399;">
            <asp:Label ID="Label1" runat="server" SkinID="header_lbl" 
                Text="Job Sheet Permission"></asp:Label>
        </div>
    ...
    Visible="False" />
        ...
        &nbsp;<asp:Button ID="Button6" runat="server" Text="Show" 
             />
        <asp:Button ID="Button11" runat="server" Text="Undo Permission" />
...
<div id="DataDiv"  align="left" 
    ...
    <asp:GridView ID="GridView1" runat="server">
        <Columns>
            <asp:CommandField ShowSelectButton="True" SelectText="Permission" />
        </Columns>
    </asp:GridView></div>
