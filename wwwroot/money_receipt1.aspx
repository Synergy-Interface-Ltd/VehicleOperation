<%@ Page Title="Money Receipt"  Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage2.master" CodeFile="money_receipt1.aspx.vb" Inherits="money_receipt1" %>
...
&nbsp;<asp:Label ID="Label7" runat="server" EnableTheming="False" Font-Names="Calibri" 
                ...
                <asp:Label ID="Label8" runat="server" EnableTheming="False" 
                    Font-Names="Calibri" Font-Size="Medium" Text="on Account of" 
                    Font-Bold="True"></asp:Label>
