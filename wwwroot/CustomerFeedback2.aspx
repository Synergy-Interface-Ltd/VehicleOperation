<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerFeedback2.aspx.cs" Inherits="CustomerFeedback2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table class="table table-bordered" style="border: 1px solid black">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtRating" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtAppoinment" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtTime" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtPerformed" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtFair" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtClean" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtOverRating" class="form-control"></asp:TextBox>
                        </td>
                    </tr>
    ...
    <div class="col-12 mt-4 mb-4">
        ...
        <asp:Button runat="server" OnClick="PrintBtn_Click" ID="printBtn" Width="200px" class="btn btn-info" Text="Print (1st CSF)" />
    </div>
