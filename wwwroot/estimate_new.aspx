<%@ Page Title="Estimate" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="estimate_new.aspx.vb" Inherits="estimate_new" %>
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
            ...
            <td align="left" valign="top" colspan="2">
                <table style="width:100%;" border="0" cellpadding="1" cellspacing="2">
                                ...
                                <ContentTemplate>
                                    <table border="0" cellpadding="2" cellspacing="0">
                                        <tr>
                                            <td colspan="4">
                                                <hr />
                                                <asp:Label ID="Label61" runat="server" Font-Bold="True" Text="Search / Manually Add Services :" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label24" runat="server" Text="Search By Part No :" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="Label25" runat="server" Text="Part/Service Name :" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label53" runat="server" Text="Service Charge :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBox33" runat="server"></asp:TextBox>
                                                <asp:Button ID="Button15" runat="server" Text="Add" ValidationGroup="service" 
                                                    Width="80px" />
                                        ...
                                        <tr>
                                            <td colspan="4">
                                               <div style="border: 0px solid #000000; width: 852px; overflow: auto;">
                                                        ...
                                                        Width="100%">
                                                          <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Qty of Service" ShowHeader="False">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("[qty1]") %>' Width="50px"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                             ...
                                             <asp:GridView Visible="false" ID="GridView10" runat="server" AutoGenerateColumns="False" 
                                                        Width="100%">
                                                        <Columns>
                                                            <asp:BoundField DataField="Service ID" HeaderText="Service ID" />
                                                            <asp:BoundField DataField="Service Category" HeaderText="Service Category" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Qty of Service" ShowHeader="False">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("[qty]") %>' Width="50px"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Unit" ShowHeader="False">
                                                                <ItemTemplate>
                                                             ...
                                                             <asp:BoundField DataField="Spare" 
                                                                HeaderText="Type" />
                                                             <asp:TemplateField HeaderText="For Order" >
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="OrderCheckbox" AutoPostBack="true" OnCheckedChanged="OrderCheckbox_Click" runat="server"  Width="20px"/>                                                          
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Part Number" >
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="PartNoBox" runat="server"  Width="50px"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <asp:Label ID="Label62" runat="server" Font-Bold="True" 
                                                    Text="Manual Parts Entry :" Width="232px"></asp:Label>
                                                <hr />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label54" runat="server" Text="Qty of Parts :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
                                                    ControlToValidate="TextBox36" Display="None" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label55" runat="server" Text="Rate of Parts :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="display:none"> 
                                                <asp:Label ID="Label59" runat="server" Text="For Order :" Width="150px"></asp:Label>
                                            </td>
                                            <td style="display:none">
                                                 <asp:CheckBox ID="ManualOrderCheckbox" AutoPostBack="true" OnCheckedChanged="ManualOrderCheckbox_Click" runat="server"  Width="20px"/>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label64" runat="server" Text="Part No :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBox41" runat="server"></asp:TextBox>
                                                <asp:Button ID="Button16" runat="server" Text="Add" ValidationGroup="service1"
                                                    Width="80px" />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label56" runat="server" Text="Description :" Width="167px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBox37" runat="server"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label57" runat="server" Text="Qty :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                                                    ControlToValidate="TextBox39" Display="None" 
                                                    ErrorMessage="Please Enter Rate..." SetFocusOnError="True" 
                                                    ValidationGroup="service2"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label68" runat="server" Text="Unit :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="Label58" runat="server" Text="Rate  :" Width="150px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBox39" runat="server"></asp:TextBox>
                                                <asp:Button ID="Button17" runat="server" Text="Add" ValidationGroup="service2" 
                                                    Width="80px" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <table border="0" cellpadding="2" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Button ID="Button18" runat="server" Text="Add" ValidationGroup="service3" 
                                                    Width="80px" />
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <ContentTemplate>
                                    <table cellpadding="2" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="Button13" runat="server" Text="Search" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Button ID="Button12" runat="server" Text="Search" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label49" runat="server" Text="Search By Part Name :" 
                                                    Width="167px"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Button ID="Button14" runat="server" Text="Search" />
                                            </td>
                                            <td>
                                                <asp:Label ID="Label50" runat="server" Text="Search By Part Description :" 
                                                    Width="200px"></asp:Label>
                                            </td>
                                            <td>
                                    ...
                                    <div style="border: 0px solid #000000; width: 927px; overflow: auto;">
                                        <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="Price">
                                                    <ItemTemplate>
                                                         <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Price") %>' Width="50px"></asp:TextBox>
                                                   </ItemTemplate>
                                                    <EditItemTemplate>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" style="border: 1px solid #000000; display: none;">
                    ...
                    <tr>
                        <td align="center" valign="top" 
                            style="border: 1px solid #000000; display: none;" colspan="2">
                            <table>
                                <tr>
                                    <td align="left" valign="top">
                    ...
                    <tr>
                        <td align="left" valign="top" 
                            style="border: 1px solid #000000; " colspan="2">
                                                <asp:Label ID="Label63" runat="server" Font-Bold="True" 
                                                    Text="Terms &amp; Conditions :" Width="232px"></asp:Label>
                                                <br />
                            <asp:TextBox ID="TextBox40" runat="server" Height="100px" TextMode="MultiLine" 
        ...
        <tr>
            <td align="center" valign="top" colspan="2">
                ...
                <asp:TextBox ID="TextBox44" runat="server" TextMode="Password"></asp:TextBox>
                <asp:Button ID="Button19" runat="server" Text="Enable Modification" />
                ...
                <asp:Button ID="Button22" runat="server" Text="Create New Estimate" />
            </td>
        </tr>
    </table>
</asp:Content>
