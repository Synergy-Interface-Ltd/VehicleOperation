<%@ Page Title="Job Wise Service Status Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="job_wise_service_report.aspx.vb" Inherits="job_wise_service_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div style="padding: 0px; margin: 0px; width: 100%; background-color: #003399;">
            <asp:Label ID="Label1" runat="server" SkinID="header_lbl" Text="Job Wise Service Status Report"></asp:Label>
        </div>
        <br />
        <br />
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
        ...
        <div id="Div3"  align="left" 
           ...
           style="border: 0px solid #333333; width: 1185px; "  
          >
            <asp:Label ID="Label2" runat="server" Text="List of Services :"></asp:Label>
           </div>
...
<div id="DataDiv"  align="left" 
    ...
    <asp:GridView ID="GridView1" runat="server" ShowFooter="True">
        ...
        <div id="Div4"  align="left" 
           ...
           style="border: 0px solid #333333; width: 1185px;">
            <asp:Label ID="Label24" runat="server" Text="List of Dent and Paint :"></asp:Label>
           </div>
