<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PrintInstantFeedback.aspx.cs" Inherits="CustomerFeedback" %>
            ...
            <table class="table table-bordered" style="border: 1px solid black">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtProblem" class="form-control"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtInform" class="form-control"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtPermission" class="form-control"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtSolving" class="form-control"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtTiming" class="form-control"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="txtBill" class="form-control"></asp:Label>
                        </td>
                    </tr>
