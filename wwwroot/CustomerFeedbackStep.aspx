<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerFeedbackStep.aspx.cs" Inherits="CustomerFeedbackStep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        <div class="col-12 row">
            ...
            <h1 class="text-center">Instant Feedback</h1>
