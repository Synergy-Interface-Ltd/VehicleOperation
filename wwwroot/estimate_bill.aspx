<%@ Page Title="Print Estimate" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="estimate_bill.aspx.vb" Inherits="estimate_bill" %>
                ...
                <table cellpadding="2" cellspacing="0" border="0" 
                    ...
                    <tr>
                        <td align="left" valign="top" width="20%">
                            <asp:Label ID="Label45" runat="server" Text="Estimated Job ID :" 
                    ...
                    <tr>
                        <td align="left" valign="top" width="20%">
                            <asp:Label ID="Label46" runat="server" Text="Estimate No :" 
                                EnableTheming="False" Font-Bold="True" Font-Names="Calibri" 
                                Font-Size="Small"></asp:Label>
                        </td>
                        <td align="left" colspan="1" valign="top" width="30%">
                        ...
                        <td width="20%" align="left" valign="top">
                            <asp:Label ID="Label47" runat="server" Text="Estimate Date :" 
                                EnableTheming="False" Font-Bold="True" Font-Names="Calibri" 
                                Font-Size="Small"></asp:Label>
                        </td>
                        <td width="30%" align="left" valign="top">
                ...
                <img id="img2" src="calendar.gif" /></a>
                    ...
                    <tr>
                        <td align="right" colspan="3" valign="top" width="70%">
                            <asp:Label ID="Label54" runat="server" EnableTheming="False" Font-Bold="True"
                                Font-Names="Calibri" Font-Size="Small" Text="Cash Discount :"></asp:Label>
                        </td>
                        <td align="right" valign="top" width="30%">
                    ...
                    <tr>
                        <td align="right" colspan="3" valign="top" width="70%">
                            ...
                            &nbsp;<asp:Label ID="Label50" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Small" Text="VAT on Service (7.5%) :"></asp:Label>
                        </td>
                        <td align="right" valign="top" width="30%">
                    ...
                    <tr>
                        <td align="right" colspan="3" valign="top" width="70%">
                            ...
                            &nbsp;<asp:Label ID="Label55" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Small" Text="VAT on Spare Parts (7.5%) :"></asp:Label>
                        </td>
                        <td align="right" valign="top" width="30%">
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;</td>
                        <td align="right" valign="top" width="20%">
                            <asp:Label ID="Label48" runat="server" Text="Advance :" EnableTheming="False" 
                                Font-Bold="True" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                        </td>
                        <td align="right" valign="top" width="30%">
                    ...
                    <tr>
                        <td align="left" colspan="4" valign="top">
                            <hr id="tnc" runat="server"/>
                            <asp:Label ID="TextBox43" runat="server" EnableTheming="False" Font-Bold="True" 
                                Font-Names="Calibri" Font-Size="Small" Font-Underline="True">Terms &amp; Conditions :</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" colspan="4" style="font-family: Calibri; font-size: small" 
                            valign="top">
                    ...
                    <tr>
                        <td align="center" colspan="4" valign="top">
                            <hr />
                            <asp:Button ID="Button2" runat="server" Text="Generate Estimate" />
                            <asp:Button ID="Button4" runat="server" Text="Delete Estimate" />
                            <asp:Button ID="Button3" runat="server" Text="Print Estimate" Width="100px" />
                            <asp:Button ID="Button40" runat="server" Text="Print Estimate(Part)" Width="130px" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
