...
Partial Class job_card
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsNothing(Request.QueryString("url")) Then
            ...
            If status.ToString() <> "" Then
                ...
                TextBox1.Focus()
            Else
                Dim a = GridView4.SelectedRow.RowIndex
    ...
    Protected Sub Button4_Click(sender As Object, e As System.EventArgs) Handles Button4.Click
        ...
        If IsNothing(Request.QueryString("url")) Then
            ...
            Dim maxiumNumber = genf.returnvaluefromdv("SELECT MAX(CAST(REPLACE(job_id, 'J-', '') AS INT)) AS MaxNumber FROM new_job_cart WHERE job_id LIKE 'J-%'", 0)

            Dim jobCartId = 1

            If maxiumNumber <> "" Then
                jobCartId = Val(maxiumNumber + 1)
            End If

            maxiumNumber = "J-" + jobCartId


            strnewrecord = "INSERT INTO [new_job_cart]"
            strnewrecord = strnewrecord & "(job_id,customer_id,[customer_name]"
            strnewrecord = strnewrecord & ",[address]"
            strnewrecord = strnewrecord & ",[email]"
            strnewrecord = strnewrecord & ",[tel]"
            strnewrecord = strnewrecord & ",[mobile]"
            ...
            strnewrecord = strnewrecord & "('" & maxiumNumber & "','" & customer_id & "','" & TextBox1.Text & "'"
            strnewrecord = strnewrecord & ",'" & TextBox2.Text & "'"
            strnewrecord = strnewrecord & ",'" & TextBox3.Text & "'"
            strnewrecord = strnewrecord & ",'" & TextBox4.Text & "'"
