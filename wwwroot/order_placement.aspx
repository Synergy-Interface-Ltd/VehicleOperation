<%@ Page Title="Order Placement" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="order_placement.aspx.vb" Inherits="ordery_placement" %>
                        ...
                        <table cellpadding="2" cellspacing="0" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="Button8" AutoPostBack="True" runat="server" Text="Search" />
                                    <br />
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label21" runat="server" Text="Part No:"></asp:Label>
                                </td>
                                <td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Order Quantity">
                                    <ItemTemplate>
                                        <asp:TextBox Text='<%#Container.DataItem("OrderLimit")%>' ID="TextBox1" runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
