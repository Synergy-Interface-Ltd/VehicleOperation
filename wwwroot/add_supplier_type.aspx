<%@ Page Title="Add Order Status" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="add_supplier_type.aspx.vb" Inherits="add_order_status" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0">
                <tr>
                    <td align="right" valign="center">
                        <asp:Label ID="Label5" runat="server" Text="Supplier Type :"></asp:Label>
                        <br />
                        <br />
